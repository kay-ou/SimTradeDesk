...
| --- | --- |
| ![Login](screenshot/Login.png) | Anmeldeoberfläche |
| ![Hauptoberfläche](screenshot/main.png) | Hauptoberfläche von SimTradeDesk |
| ![Dunkelmodus](screenshot/dark_mode.png) | Dunkles Farbschema |
| ![NAV-Überlagerung](screenshot/NAV_overlay.png) | Backtest-Vergleich mit überlagerten NAV-Kurven |
| ![Handelsdetails](screenshot/trade_details.png) | Handelsdetail-Tabelle |
| ![Optimierer](screenshot/optimizier.png) | Parameteroptimierung |
| ![Datenverwaltung](screenshot/data_management.png) | Datenverwaltung |
| ![Versions-Diff](screenshot/verion_diff.png) | Versionshistorie mit Diff-Ansicht |
| ![Einstellungen](screenshot/user_settings.png) | Benutzereinstellungen |
| ![Terminal](screenshot/terminal.png) | Integriertes Terminal |
